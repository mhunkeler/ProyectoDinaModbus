...
#define TRIS_RFXReset TRIS_RESET
#define RFXReset  RESET
#define PIN_RFXReset PIN_RESET
#define LAT_RFXReset LAT_RESET
#define TRIS_SCX1   TRIS_SCLKRF
#define RPOUT_SCX1  RPOUT_SCLKRF
#define TRIS_CSB1   TRIS_SEL
#define RPOUT_CSB1  RPOUT_SEL
#define RFXNCS      SEL
#define TRIS_RFXNCS TRIS_SEL
#define PIN_RFXNCS  PIN_SEL
#define LAT_RFXNCS  LAT_SEL
#define TRIS_SDI1   TRIS_SDI
#define RPIN_SDI1   RPIN_SDI
#define TRIS_SDO1   TRIS_SDO
#define RPOUT_SDO1  RPOUT_SDO
#define RegFifo         0x00
