...
#define RPOUT_U1_RTS RPOUT_MODBUS_RTS
#define RPIN_U1_CTS RPIN_MODBUS_CTS
...
int16_t hold_regs[8] = {168,0,1,6469,100,58,1,1024}; // carrera, offsetAcc,spanAcc, offsetFuerza,spanFuerzaN,spanFuerzaD, metodoAcc, ajustAcc
